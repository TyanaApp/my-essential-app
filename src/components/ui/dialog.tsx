  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Desktop positioning
        "sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:rounded-lg",
        ...
        "max-sm:pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))]",
        className,
      )}
      {...props}
    >
      {/* Mobile drag handle */}
      <div className="mx-auto w-10 h-1 rounded-full bg-muted-foreground/30 sm:hidden shrink-0 -mt-2 mb-1" />
      {children}
