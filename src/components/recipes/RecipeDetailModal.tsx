      ...
      <AnimatePresence mode="wait">
        ...
        {step === 'detail' && (
          <motion.div key="detail" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <div className="fixed bottom-[calc(64px+env(safe-area-inset-bottom,0px))] md:bottom-0 left-0 right-0 px-5 pb-4 pt-3 z-50 bg-gradient-to-t from-background via-background to-transparent">
