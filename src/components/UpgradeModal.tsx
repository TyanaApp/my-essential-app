...
const T = {
  en: {
    ...
    switchToLite: 'Switch to Lite — €5.99/mo',
  ...
  ru: {
    ...
    switchToLite: 'Перейти на Lite — €5.99/мес',
  ...
  lv: {
    ...
    switchToLite: 'Pāriet uz Lite — €5.99/mēn',
    downgradeToLite: 'Pazemināt uz Lite',
    getLite: 'Iegūt Lite — €5.99/mēn',
  ...
  uk: {
    ...
    downgradeToFree: 'Перейти на Free',
    switchToLite: 'Перейти на Lite — €5.99/міс',
    downgradeToLite: 'Знизити до Lite',
    getLite: 'Перейти на Lite — €5.99/міс',
