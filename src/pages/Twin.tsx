...
import { Sparkles, Send, RotateCcw, Bot, User, Mic, Loader2, Volume2, VolumeX, MessageSquare, Phone } from 'lucide-react';
...
import VoiceAssistant from '@/components/twin/VoiceAssistant';
    ...
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="p-4 border-b border-border flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-orbitron font-bold text-foreground">AI {t('twin')}</h1>
