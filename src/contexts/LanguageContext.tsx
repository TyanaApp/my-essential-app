...
const translations: Translations = {
  ...
  legal: { en: 'Legal', ru: 'Правовая информация', lv: 'Juridiskā informācija' },
  privacyPolicy: { en: 'Privacy Policy', ru: 'Политика конфиденциальности', lv: 'Privātuma politika' },
  termsOfService: { en: 'Terms of Service', ru: 'Условия использования', lv: 'Lietošanas noteikumi' },
  cookiePolicy: { en: 'Cookie Policy', ru: 'Политика Cookie', lv: 'Sīkdatņu politika' },
